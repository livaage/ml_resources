---
title: Independent Component Analysis (ICA) — ML Resources Hub
eyebrow_text: ← Theory · Dimensionality Reduction
eyebrow_href: {{root}}theory.html
heading: Independent Component Analysis (ICA)
lead: Recover statistically-independent sources from their mixtures — the cocktail-party algorithm.
prev_href: umap.html
prev_title: UMAP
---
...
<span class="viz-embed-title">Cocktail party — two sources, two mixed observations, two ICA-recovered signals</span>
</div>
<div class="viz-classic-controls">
<button id="viz-ica-sources" type="button" class="active">Sources</button>
<button id="viz-ica-mixed" type="button">Mixed (observed)</button>
<button id="viz-ica-pca" type="button">PCA recovery</button>
<button id="viz-ica-ica" type="button">ICA recovery</button>
</div>
<div class="viz-classic-canvas-wrap">
<canvas id="viz-ica-canvas"></canvas>
</div>
<div class="viz-classic-caption" id="viz-ica-caption"></div>
</div>

<script src="{{root}}js/viz/ica.js"></script>
...
<span>Want the FastICA algorithm, negentropy, and applications?</span>
...
<span class="key-idea-label">Maximising non-Gaussianity</span>

<div class="notation-standard" markdown="1">

<span class="formula">$$ \max_w \; J(w^\top x) \;\;\text{s.t.}\;\; \mathbb{E}[(w^\top x)^2] = 1 $$</span>

<ul class="formula-legend" markdown="1">
<li markdown="1">

`J`non-Gaussianity measure — kurtosis, negentropy, or log-cosh contrast
...
<span class="formula">$$ \max_w \;\; \text{non-Gaussianity of (combination of observations)} \;\;\text{such that}\;\; \text{average squared combination} \;=\; 1 $$</span>
...
`w`unmixing weights — one per source

</li>
<li markdown="1">

`w · x`weighted combination of the observations (one candidate recovered source)
...
`average squared = 1`unit-variance constraint that makes the answer unique
...
<div class="level-next">
<span>Want InfoMax, JADE, non-linear ICA, and applications to neuroscience?</span>
...
<span class="key-idea-label">Negentropy</span>

<div class="notation-standard" markdown="1">

<span class="formula">$$ J(y) = H(y_\text{gauss}) - H(y) \;\;\geq\;\; 0 $$</span>
...
`ygauss`Gaussian with the same variance
...
<span class="formula">$$ \text{non-Gaussianity score} \;=\; \text{entropy of matched Gaussian} \;-\; \text{entropy of signal} \;\;\geq\;\; 0 $$</span>
...
`matched Gaussian`a Gaussian with the same variance as the signal
...
[Hyvärinen & Oja (2000) — ICA Tutorial <i class="fas fa-external-link-alt"></i>](https://www.cs.helsinki.fi/u/ahyvarin/papers/NN00new.pdf){: target="_blank" }
<span class="annotation">The canonical ICA tutorial. Readable, comprehensive, covers FastICA, InfoMax, and the underlying theory.</span>

</li>
<li data-tier="intuition" markdown="1">

[scikit-learn — Blind Source Separation Example <i class="fas fa-external-link-alt"></i>](https://scikit-learn.org/stable/auto_examples/decomposition/plot_ica_blind_source_separation.html){: target="_blank" }
<span class="annotation">The classic cocktail-party example with code. The quickest hands-on intro to ICA.</span>

</li>
<li data-tier="fundamentals" markdown="1">

[MNE — ICA for EEG / MEG <i class="fas fa-external-link-alt"></i>](https://mne.tools/stable/auto_tutorials/preprocessing/40_artifact_correction_ica.html){: target="_blank" }
<span class="annotation">The neuroscience-grade reference for ICA in practice. Worked examples on real EEG data with blink / muscle component identification.</span>

</li>
<li data-tier="indepth" markdown="1">

[Khemakhem et al. (2020) — iVAE / Identifiable ICA <i class="fas fa-external-link-alt"></i>](https://arxiv.org/abs/2010.12148){: target="_blank" }
<span class="annotation">The bridge between classical ICA and modern deep generative models. Identifiable non-linear ICA via VAEs with auxiliary variables.</span>
